#ifndef __SN32F760B_FLASH_H
#define __SN32F760B_FLASH_H
...
#define	FLASH_F760B_MAX_ROM_SIZE		0xFFFF
...
#define	__FLASH_LPM_FAST_MODE				SN_FLASH->LPCTRL = 0x5AFA0004;SN_FLASH->LPCTRL = 0x5AFA0005;		//HCLK>24MHz
